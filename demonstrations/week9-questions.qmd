...
c. What is the maximum likelihood estimate for AR(1)?

## 3. Limiting forecast distribution

What does the forecast distribution converge to as $n \to \infty$?
...
Fit a nonlinear AR model on the `globtemp` dataset. 
Compute its sum of squared residuals and compare it to that of a linear AR model.